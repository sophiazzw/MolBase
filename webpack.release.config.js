...
module.exports = {
    output: {
        path: path.join(__dirname, 'release'), //输出目录的配置，模板、样式、脚本、图片等资源的路径配置都相对于它
        publicPath: '/MolBase/release', //模板、样式、脚本、图片等资源对应的server上的路径
...
function runtime(page) {
    var entryID = moduleName + "/" + page + "/" + page; // pc-cn-biz/pageA
